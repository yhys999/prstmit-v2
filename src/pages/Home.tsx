        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <Badge
                variant="secondary"
                className="px-4 py-1 text-primary border-primary/20 bg-primary/10"
              >
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-xl">
                We provide the most competitive rates and instant payout,
                ensuring your profits grow seamlessly with Africa's most trusted
                trading platform.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                >
                  <a href="#calculator">
                    Check Rates <ArrowRight className="ml-2 h-5 w-5" />
                  </a>
                </Button>
              </div>
              <div className="flex items-center gap-6 pt-4">
                ...
                <p className="text-sm font-medium">
                  <span className="text-primary">100,000+</span> satisfied
                  customers
                </p>
              </div>
            </motion.div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 max-w-4xl mx-auto">
            <div className="text-center md:text-left">
              <h3 className="text-xl md:text-2xl font-bold text-[#25D366] mb-1">
                JOIN PRSTMIT TODAY
              </h3>
              <p className="text-sm md:text-base text-muted-foreground">
                Chat with Joyce • Get instant quotes • Start trading now
              </p>
            </div>
            <Button
              size="lg"
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground">
                Select your gift card type and see how much Naira (₦) you'll
                receive instantly
              </p>
            </div>
            ...
            <Card className="border-none shadow-2xl bg-card overflow-hidden">
              <div className="grid lg:grid-cols-5">
                ...
                <div className="lg:col-span-2 bg-primary p-6 md:p-8 lg:p-12 text-primary-foreground flex flex-col justify-center items-center text-center space-y-4 md:space-y-6">
                  <div>
                    <p className="text-primary-foreground/80 uppercase tracking-widest text-sm font-bold mb-2">
                      You Will Receive
                    </p>
                  ...
                  >
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      <SiWhatsapp className="mr-2 h-4 w-4 md:h-5 md:w-5" />{" "}
                      TRADE THIS CARD
                    </a>
                  </Button>
                </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                Ready for higher profits? See what our customers say about
                trading with Joyce
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <div className="space-y-4">
              ...
              <h2 className="text-3xl md:text-4xl font-bold">
                Why Choose WhatsApp Trading?
              </h2>
              <p className="text-muted-foreground text-lg">
                Experience the fastest, most convenient way to trade gift cards
                in Africa
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="p-6 bg-white rounded-2xl shadow-lg border border-[#25D366]/10">
                ...
                <p className="text-sm text-muted-foreground">
                  Joyce responds within 30 seconds, 24/7
                </p>
              </div>
              ...
              <div className="p-6 bg-white rounded-2xl shadow-lg border border-[#25D366]/10">
                ...
                <p className="text-sm text-muted-foreground">
                  Direct communication with Joyce
                </p>
              </div>
            </div>
            ...
            >
              <a
                ...
                rel="noopener noreferrer"
              >
                <SiWhatsapp className="mr-3 h-6 w-6" /> Start Trading on
                WhatsApp
              </a>
            </Button>
          </div>
            ...
            <div className="relative z-10 grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-8">
                <h2 className="text-3xl md:text-5xl font-bold leading-tight">
                  Professional Gift Card Exchange
                </h2>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-background/60">
                        ...
                        information and funds are completely secure.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-background/60">
                        We guarantee the most competitive rates in the market
                        with no hidden fees. What you see is what you get.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-bold text-xl mb-1">
                        Joyce - Personal Support
                      </h3>
                      <p className="text-background/60">
                        Personalized service experience. Any questions get
                        genuine responses within minutes via WhatsApp.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="relative">
              <div className="rounded-3xl overflow-hidden shadow-2xl relative z-10">
                <img
                  src={IMAGES.CUSTOMER_SERVICE_2}
                  alt="Joyce Customer Service"
                ...
                <div className="absolute bottom-8 left-8 right-8">
                  ...
                  <h3 className="text-2xl font-bold text-white">
                    Joyce - Your Trading Expert
                  </h3>
                  <p className="text-white/80">
                    "I'm here to ensure every trade is smooth, fast, and
                    profitable for you."
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-10">
              <div className="space-y-4">
                ...
                <p className="text-lg md:text-xl text-muted-foreground">
                  Click the button below to chat with Joyce on WhatsApp and
                  start your first lightning-fast trade.
                </p>
              </div>
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h4 className="text-lg md:text-xl font-bold text-[#25D366]">
                      Contact Joyce via WhatsApp
                    </h4>
                    <p className="text-sm md:text-base text-muted-foreground">
              ...
              <div className="pt-6 border-t">
                <p className="text-sm text-muted-foreground flex items-center gap-2">
                  <MessageCircle className="h-4 w-4" /> Average response time:
                  32 seconds
                </p>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-2xl mx-auto space-y-6">
            <h2 className="text-2xl md:text-3xl font-bold">
              Ready to Get the Best Rates?
            </h2>
            <p className="text-muted-foreground">
              Join thousands of satisfied customers who trust Joyce for their
              gift card trading
            </p>
